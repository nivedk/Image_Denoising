...
class ResnetGenerator(nn.Module):
    def __init__(self, input_nc, output_nc, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False, n_blocks=6, padding_type='reflect'):
        ...
        self.inc = Inconv(input_nc, ngf, norm_layer, use_bias)      # 256x256
        self.down1 = Down(ngf, ngf * 2, norm_layer, use_bias)       # 128x128
        self.down2 = Down(ngf * 2, ngf * 4, norm_layer, use_bias)   # 64x64
        self.down3 = Down(ngf * 4, ngf * 8, norm_layer, use_bias)   # 32x32
        ...
        self.up1 = Up(ngf * 8, ngf * 4, norm_layer, use_bias)          # 64x64
        self.up2 = Up(ngf * 4 * 2, ngf * 2, norm_layer, use_bias)      # 128x128
        self.up3 = Up(ngf * 2 * 2, ngf, norm_layer, use_bias)          # 256x256
...
class Up(nn.Module):
    def __init__(self, in_ch, out_ch, norm_layer, use_bias):
        ...
        self.up = nn.Sequential(
            ...
            SpectralTransposeConv(in_ch, out_ch,
